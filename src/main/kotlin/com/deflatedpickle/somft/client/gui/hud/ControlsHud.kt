...
import com.deflatedpickle.somft.api.HorizontalTextAnchor.EAST
import com.deflatedpickle.somft.api.HorizontalTextAnchor.WEST
...
import com.deflatedpickle.somft.api.VerticalTextAnchor.NORTH
import com.deflatedpickle.somft.api.VerticalTextAnchor.SOUTH
...
class ControlsHud(
    ...
    fun render(graphics: GuiGraphics) {
        if (this.client.options.debugEnabled || !SomftClient.CONFIG.hudConfig.showControls) return
        ...
        for ((i, entry) in category.entries.withIndex()) {
            ...
            if (bind != null) {
                ...
                graphics.drawShadowedText(
                    ...
                    y,
                    when {
                        bind.isPressed -> SomftClient.CONFIG.hudConfig.controlsHUDConfig.pressedColour
                        bind.isUnbound -> SomftClient.CONFIG.hudConfig.controlsHUDConfig.unboundColour
                        else -> SomftClient.CONFIG.hudConfig.controlsHUDConfig.colour
                    }
                )
            }
        }
